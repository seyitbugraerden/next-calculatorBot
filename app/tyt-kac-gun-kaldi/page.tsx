  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center overflow-x-hidden">
      <div className="flex flex-col items-center justify-center">
        <div className="bg-gray-200 border border-gray-300 rounded-lg p-4 max-w-md mx-auto text-center shadow-md">
          <div className="flex flex-row justify-center items-center gap-3">
            <Image
              src="/clock.png"
              alt="TYT Kaç Gün Kaldı"
              width={32}
              height={32}
            />
            <h1 className="text-3xl font-bold mb-2">TYT Kaç Gün Kaldı</h1>
          </div>
